...
import { ProficiencyLevel, NotificationSettings, FeedbackIntensity } from '../types';
import { clearAllData, getNotificationSettings, saveNotificationSettings, getStreakFreezeStatus, addStreakFreeze, getCalmMode, setCalmMode, getFeedbackIntensity, setFeedbackIntensity } from '../utils/storage';
import {
...
const SettingsScreen: React.FC<SettingsScreenProps> = ({
  ...
  // Bildirim, freeze ve geri bildirim ayarlarini yukle
  useEffect(() => {
    getNotificationSettings().then(setNotifSettings);
    getStreakFreezeStatus().then(status => {
      setFreezeCount(status.count);
      setFreezeActive(status.isActive);
    });
    getFeedbackIntensity().then(setFeedbackMode);
  }, []);
  ...
  // Saat secimi icin basit +/- kontrolleri
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.card}>
              <View style={styles.settingRow}>
                ...
                <Text style={styles.settingTextMuted}>{Constants.expoConfig?.version ?? '1.4.0'}</Text>
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  // Geri bildirim siddeti radio butonlari
  feedbackRadio: {
    width: 22,
    height: 22,
    borderRadius: 11,
